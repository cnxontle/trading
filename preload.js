window.addEventListener('DOMContentLoaded', () => {
    ...
    const tickers = {
        ...
        "COMMOD_SOYBEAN": document.querySelector('p[data-testid="watchlist_value_ZSK5"]'),
        "COMMOD_CORN": document.querySelector('p[data-testid="watchlist_value_ZCK5"]'),
        "COMMOD_WHEAT": document.querySelector('p[data-testid="watchlist_value_ZWK5"]'),
        "COMMOD_SUGAR": document.querySelector('p[data-testid="watchlist_value_SBK5"]'),
        "COMMOD_COFFE": document.querySelector('p[data-testid="watchlist_value_KCK5"]'),
        "COMMOD_HEATING_OIL": document.querySelector('p[data-testid="watchlist_value_HOJ5"]'),
        "COMMOD_CRUDE_OIL": document.querySelector('p[data-testid="watchlist_value_CLK5"]'),
        "COMMOD_BRENT_CRUDE": document.querySelector('p[data-testid="watchlist_value_BRNQ5"]'),
        "COMMOD_NATURAL_GAS": document.querySelector('p[data-testid="watchlist_value_NGJ25"]'),
        "COMMOD_GASOLINE": document.querySelector('p[data-testid="watchlist_value_RBJ5"]'),
        "COMMOD_SILVER": document.querySelector('p[data-testid="watchlist_value_SIK25"]'),
        "COMMOD_COPPER": document.querySelector('p[data-testid="watchlist_value_HGK5"]'),
        ...
        "INDEX_NASDAQ_100": document.querySelector('p[data-testid="watchlist_value_NQM5"]'),
        "INDEX_SP_500": document.querySelector('p[data-testid="watchlist_value_ESM5"]'),
        ...
        "INDEX_US_DOLLAR": document.querySelector('p[data-testid="watchlist_value_DXM5"]'),
