window.addEventListener('DOMContentLoaded', () => {
    ...
    const tickers = {
        ...
        "TAO_USDT": document.querySelector('p[data-testid="watchlist_value_TAO/USDT"]'),
        "RESERVADO2": document.querySelector('p[data-testid="watchlist_value_TON/U4SDT"]'),
        "ISHARES_GERMANY": document.querySelector('p[data-testid="watchlist_value_EWG"]'),
        "RESERVADO3": document.querySelector('p[data-testid="watchlist_value_SUI/U4SDT"]'),
        "RESERVADO4": document.querySelector('p[data-testid="watchlist_value_S/USD4T"]'),
        ...
        "COMMOD_SOYBEAN": document.querySelector('p[data-testid="watchlist_value_ZSX5"]'),
        "COMMOD_CORN": document.querySelector('p[data-testid="watchlist_value_ZCZ5"]'),
        "COMMOD_WHEAT": document.querySelector('p[data-testid="watchlist_value_ZWU5"]'),
        "COMMOD_SUGAR": document.querySelector('p[data-testid="watchlist_value_SBV5"]'),
        "COMMOD_COFFE": document.querySelector('p[data-testid="watchlist_value_KCU5"]'),
        "COMMOD_HEATING_OIL": document.querySelector('p[data-testid="watchlist_value_HOQ5"]'),
        "COMMOD_CRUDE_OIL": document.querySelector('p[data-testid="watchlist_value_CLU5"]'),
        "COMMOD_BRENT_CRUDE": document.querySelector('p[data-testid="watchlist_value_BRNU5"]'),
        "COMMOD_NATURAL_GAS": document.querySelector('p[data-testid="watchlist_value_NGQ25"]'),
        "COMMOD_GASOLINE": document.querySelector('p[data-testid="watchlist_value_RBQ5"]'),
        "COMMOD_SILVER": document.querySelector('p[data-testid="watchlist_value_SIU25"]'),
        "COMMOD_COPPER": document.querySelector('p[data-testid="watchlist_value_HGU5"]'),
        "COMMOD_GOLD": document.querySelector('p[data-testid="watchlist_value_GCQ5"]'),
        "COMMOD_PLATINUM": document.querySelector('p[data-testid="watchlist_value_PLV5"]'),
        "INDEX_VIX": document.querySelector('p[data-testid="watchlist_value_VXQ5"]'),
        "INDEX_RUSSELL_2000": document.querySelector('p[data-testid="watchlist_value_IWM"]'),
        "INDEX_NASDAQ_100": document.querySelector('p[data-testid="watchlist_value_NQU5"]'),
        "INDEX_SP_500": document.querySelector('p[data-testid="watchlist_value_ESU5"]'),
        ...
        "INDEX_US_DOLLAR": document.querySelector('p[data-testid="watchlist_value_DXU5"]'),
        "INDEX_NIKKEI_YEN": document.querySelector('p[data-testid="watchlist_value_EWJ"]'),
        "SUI_USDT": document.querySelector('p[data-testid="watchlist_value_SUI/USDT"]'),
        "FOREX_EURO_USD": document.querySelector('p[data-testid="watchlist_value_EUR/USD"]'),
        "S_USDT": document.querySelector('p[data-testid="watchlist_value_S/USDT"]'),
        ...
        "TON_USDT": document.querySelector('p[data-testid="watchlist_value_TON/USDT"]'),
