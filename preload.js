window.addEventListener('DOMContentLoaded', () => {
    ...
    const tickers = {
        ...
        "COMMOD_HEATING_OIL": document.querySelector('p[data-testid="watchlist_value_HOG5"]'),
        "COMMOD_CRUDE_OIL": document.querySelector('p[data-testid="watchlist_value_CLG5"]'),
        "COMMOD_BRENT_CRUDE": document.querySelector('p[data-testid="watchlist_value_BRNH5"]'),
        "COMMOD_NATURAL_GAS": document.querySelector('p[data-testid="watchlist_value_NGG25"]'),
        "COMMOD_GASOLINE": document.querySelector('p[data-testid="watchlist_value_RBG5"]'),
