window.addEventListener('DOMContentLoaded', () => {
    ...
    const tickers = {
        ...
        "COMMOD_HEATING_OIL": document.querySelector('p[data-testid="watchlist_value_HOF5"]'),
        "COMMOD_CRUDE_OIL": document.querySelector('p[data-testid="watchlist_value_CLF5"]'),
        "COMMOD_BRENT_CRUDE": document.querySelector('p[data-testid="watchlist_value_BRNG5"]'),
        "COMMOD_NATURAL_GAS": document.querySelector('p[data-testid="watchlist_value_NGF25"]'),
        "COMMOD_GASOLINE": document.querySelector('p[data-testid="watchlist_value_RBF5"]'),
        ...
        "COMMOD_GOLD": document.querySelector('p[data-testid="watchlist_value_GCG5"]'),
