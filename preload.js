window.addEventListener('DOMContentLoaded', () => {
    ...
    const tickers = {
        ...
        "COMMOD_SOYBEAN": document.querySelector('p[data-testid="watchlist_value_ZSF5"]'),
        ...
        "COMMOD_HEATING_OIL": document.querySelector('p[data-testid="watchlist_value_HOZ4"]'),
        "COMMOD_CRUDE_OIL": document.querySelector('p[data-testid="watchlist_value_CLF5"]'),
        "COMMOD_BRENT_CRUDE": document.querySelector('p[data-testid="watchlist_value_BRNF5"]'),
        "COMMOD_NATURAL_GAS": document.querySelector('p[data-testid="watchlist_value_NGZ24"]'),
        "COMMOD_GASOLINE": document.querySelector('p[data-testid="watchlist_value_RBZ4"]'),
        ...
        "INDEX_US_DOLLAR": document.querySelector('p[data-testid="watchlist_value_DXZ4"]'),
