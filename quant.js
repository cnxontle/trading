...
function obtenerValor() {
    ...
    const nuevosTickers = {
        ...
        "COMMOD_SOYBEAN": document.querySelector('p[data-testid="watchlist_value_ZSX4"]'),
        "COMMOD_CORN": document.querySelector('p[data-testid="watchlist_value_ZCZ4"]'),
        "COMMOD_WHEAT": document.querySelector('p[data-testid="watchlist_value_ZWZ4"]'),
        "COMMOD_SUGAR": document.querySelector('p[data-testid="watchlist_value_SBV4"]'),
        "COMMOD_COFFE": document.querySelector('p[data-testid="watchlist_value_KCZ4"]'),
        "COMMOD_HEATING_OIL": document.querySelector('p[data-testid="watchlist_value_HOV4"]'),
        "COMMOD_CRUDE_OIL": document.querySelector('p[data-testid="watchlist_value_CLV4"]'),
        "COMMOD_BRENT_CRUDE": document.querySelector('p[data-testid="watchlist_value_BRNX4"]'),
        "COMMOD_NATURAL_GAS": document.querySelector('p[data-testid="watchlist_value_NGV24"]'),
        "COMMOD_GASOLINE": document.querySelector('p[data-testid="watchlist_value_RBV4"]'),
        "COMMOD_SILVER": document.querySelector('p[data-testid="watchlist_value_SIZ24"]'),
        ...
        "COMMOD_PLATINUM": document.querySelector('p[data-testid="watchlist_value_PLV4"]'),
        "INDEX_VIX": document.querySelector('p[data-testid="watchlist_value_VXU4"]'),
        "INDEX_RUSSELL_2000": document.querySelector('p[data-testid="watchlist_value_IWM"]'),
        "INDEX_NASDAQ_100": document.querySelector('p[data-testid="watchlist_value_NQU4"]'),
        "INDEX_SP_500": document.querySelector('p[data-testid="watchlist_value_ESU4"]'),
        ...
        "INDEX_US_DOLLAR": document.querySelector('p[data-testid="watchlist_value_DXU4"]'),
