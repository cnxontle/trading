...
/*Seleccionar con suma total de las columnas
	mostrar solo las cryptomonedas para hacer este analizis
*/
SELECT 
    id,
    -- Columna tiempo formateada
...
*/
    -- Columna adicional con la suma total
